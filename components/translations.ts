...
export const translations = {
  en: {
    ...
    tagLine: "Tag line",
    server: "Server",
    riotIdHelpPrefix: "Riot IDs use the format",
    riotIdHelpExample: "for example",
  ...
  "es-LATAM": {
    ...
    tagLine: "Etiqueta",
    server: "Servidor",
    riotIdHelpPrefix: "Los Riot ID usan el formato",
    riotIdHelpExample: "por ejemplo",
    loadProfile: "Cargar perfil",
    refreshLive: "Actualizar",
    recentMatches: "Partidas recientes",
    liveTimeline: "Timeline de partidas en vivo",
    matchDetails: "Detalles de partida",
